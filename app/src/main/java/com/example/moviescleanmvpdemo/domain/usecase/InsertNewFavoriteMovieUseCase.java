...
public class InsertNewFavoriteMovieUseCase extends BaseCompletableUseCase<Movie, Void, Void> {

    private final FavouriteMoviesRepository repository;

    public InsertNewFavoriteMovieUseCase() {
